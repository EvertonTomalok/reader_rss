from controles.geradornoticias import crawl_noticias, clear
...
def menu():
    while True:
        ...
        if escolha == 1:
            ...
            todos_links = {ultimas_noticias, economia, politica, esportes, cinema, saude, brasil_e_mundo,
                               automoveis,transito, saude, cultura_tecnologia_ciencia, educacao}
